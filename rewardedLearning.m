                    ...
                    if mode.eyetracking_mode == 1
                        ...
                        WaitSecs(getTime('ShowFeedback', mode.debug_on));
                         ...
                         if flow.isCorrect   
                           ...
                           conf.moneydil =  (1-data.Trials(flow.nresp-1, 11))*2;
                           elseif data.Trials(flow.nresp-1, 8)==2
                           conf.moneydil =  (1-data.Trials(flow.nresp-1, 11))*0.2;
                           end
                        data.Trials(flow.nresp-1, 15) =  conf.moneydil;
...
% End of Experiment; close the file first, close graphics window, close data file and shut down tracker
    ...
    disp(['The mean eye movement is  ' num2str(showEyeMean) '°！'])
