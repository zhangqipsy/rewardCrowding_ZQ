...
%     conf.color.distractors = {fromLab.cyan ,fromLab.orange ,fromLab.purple};
    ...
    conf.color.distractors = {fromLab.cyan,fromLab.cyan1,fromLab.cyan2,fromLab.orange1,fromLab.orange2,fromLab.orange3,fromLab.orange4,fromLab.orange,fromLab.orange5,fromLab.orange6};
